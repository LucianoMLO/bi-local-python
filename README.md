...
| Arquivo | Descrição |
|---|---|
| `index.html` | Dashboard interativo com dados sintéticos — demo do conceito |
...
O arquivo `index.html` é um dashboard funcional com dados sintéticos que ilustra o conceito:
...
- Rodapé dinâmico com legendas dos indicadores e sugestões de ação por KPI
- Gerado por script Python a partir de um banco SQLite local

👉 **[Acesse a demo ao vivo — GitHub Pages](https://lucianomlo.github.io/bi-local-python/)**
...
Você quer criar um painel de indicadores semelhante a este — com dados comerciais, de CS, RH ou qualquer outra área, a partir dos seus dados de sistema, planilhas ou arquivos .csv?

Estou estruturando **suporte aos interessados aos sábados** e em breve lanço um **curso rápido: do zero ao seu primeiro BI em HTML**.

Entre em contato pelo LinkedIn ou abra uma [issue neste repositório](https://github.com/LucianoMLO/bi-local-python/issues). 🚀
...
| File | Description |
|---|---|
| `index.html` | Interactive dashboard with synthetic data — concept demo |
...
The `index.html` file is a functional dashboard with synthetic data illustrating the concept:
...
- Dynamic footer with indicator legends and action suggestions per KPI
- Generated by a Python script from a local SQLite database

👉 **[Access the live demo — GitHub Pages](https://lucianomlo.github.io/bi-local-python/)**
...
Interested in creating a similar indicators panel — with commercial, CS, HR or any other area data, from your system exports, spreadsheets or .csv files?

I am organizing **Saturday support sessions** for those getting started, and will soon launch a **quick course: from zero to your first HTML BI dashboard**.

Reach out on LinkedIn or open an [issue in this repository](https://github.com/LucianoMLO/bi-local-python/issues). 🚀
